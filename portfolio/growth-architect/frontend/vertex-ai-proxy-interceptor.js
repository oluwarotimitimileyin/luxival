...
(function() {
  ...
  function resolveProxyEndpoint() {
    ...
    return isLocalhost ? 'http://127.0.0.1:5000/api-proxy' : '/api-proxy';
  }
      ...
      try {
        ...
        const proxyFetchOptions = {
          ...
          headers: {
            ...
            'X-App-Proxy': 'Ik19oFXMS5gac9tDIkCG2483h3BCnTil',
          },
          body: JSON.stringify(requestDetails),
        };

        const proxyEndpoint = resolveProxyEndpoint();
        console.log(`[Vertex AI Proxy Shim] Fetching from proxy endpoint: ${proxyEndpoint}`);
